#!/usr/bin/env python3
"""
ALOHA Training Example
======================
Train VLA model on ALOHA dataset
"""
...
def main():
    print("=== ALOHA VLA Training Example ===\n")
    
    # Load configurations
    config = merge_configs(
        get_default_config(),
        load_configs('configs/model/pi0_base.yaml'),
        load_configs('configs/data/aloha.yaml'),
        load_configs('configs/training/aloha_finetune.yaml'),
    )
    
    # Update action dim for ALOHA (14 DoF)
    config['model']['action_head']['action_dim'] = 14
